...
- `workflowSteps`: durable, idempotent orchestration steps with lifecycle timestamps, attempt, timeout, summaries, optional token/cost/duration metrics, and typed failure code; scheduled/running rows are resumable after interruption.
